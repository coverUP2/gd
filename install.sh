...
install_depend(){
    ...
    # 模块依赖
    pip3 install -i https://pypi.mirrors.ustc.edu.cn/simple/ qrcode==7.3.1 Telethon==1.24.0 requests==2.27.1 Pillow==9.0.0 python-socks==1.2.4 async_timeout==4.0.2 prettytable==3.0.0
...
gitPull(){
    ...
    cd ${QLMainPath}/repo && rm -rf gd && git clone ${daili}https://github.com/CoverUp137/gd.git
